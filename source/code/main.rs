...
fn spawn_camera_system(
    ...
    commands
        .spawn((
              ...
              CylinderActorCameraBundle {
                parent_transform: ParentTransformVariablesComponent {
                  transform: *next_observed_character.1
                },
                desired_parent_transform: DesiredTransformParentVariablesComponent {
                  transform: *next_observed_character.1
                },
